      ...
      iconElementLeft={
        props.selected === 'ALL'
          ...
          : <IconMenu
            ...
            >
              <MenuItem
                onTouchTap={props.kickPlayer.bind(null, props.selected)}
                primaryText="Kick"
              />
              <MenuItem
                onTouchTap={props.banPlayer.bind(null, props.selected)}
                primaryText="Ban"
              />
              <MenuItem
                onTouchTap={props.unWhiteListPlayer.bind(null, props.selected)}
