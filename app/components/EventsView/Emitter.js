    ...
    <ListItem
      ...
      rightIconButton={(
        <IconMenu iconButtonElement={iconButtonElement}>
          ...
          <MenuItem primaryText="Ban" onTouchTap={props.banPlayer.bind(null, props.steam)}/>
          <MenuItem primaryText="UnWhiteList" onTouchTap={props.unWhiteListPlayer.bind(null, props.steam)}/>
        </IconMenu>
      )}
